...
class Wikitool():
    def __init__(self, username, password, language):
        self.wiki_url = "https://sanat.csc.fi/w/"
    ...
    def get_pages(self, additional_parameters="", all_pages=False):
        post_parameters = {"action": "query", "list": "categorymembers", "cmtitle": "Category:" + self.language.title(), "cmlimit": 100000, "format": "json", "token": self.token}
        if all_pages:
