...
function formFromLgXML(json, xmlTag, classPrefix){
	...
	if (etymologies == undefined || etymologies.length==0){
        place_holder = place_holder + "</ul><button onclick='addHTMLtoEventTarget(event, lgRootAttributeHTML)'>Lisää arvo</button></div>";
...
function addTranslation(event){
	...
	var row = HTMLtoDOM(translationTableRowHTML({"word":"","pos":""}), "table");
...
var supported_languages = ["fin", "eng", "rus", "deu", "nob", "sme", "smn", "sjd", "sma", "sju", "sjd", "sje", "smj", "sjt", "sms", "est", "fit", "fkv", "hun", "izh", "kca", "koi", "kpv", "lav", "liv", "mdf", "mhr", "mns", "mrj", "myv", "nio", "olo", "udm", "vep", "vot", "vro", "yrk", "non", "rom", "ron", "som", "swe", "krl", "lud", "fra"];
